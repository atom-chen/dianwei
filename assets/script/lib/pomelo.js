...
pomeloRequire.register("pomelonode~pomelo-jsclient-websocket@master", function (exports, module) {
    (function () {
        ...
        var sendMessage = function (reqId, route, msg) {
            if (console) {
                // console.debug("====>" + route + "::" + JSON.stringify(msg));
            }
            if (useCrypto) {
        ...
        var processMessage = function (pomelo, msg) {
            if (console) {
                // console.debug("<====" + msg.route + "::" + JSON.stringify(msg.body));
            }
            if (!msg.id) {
                // server push message
        ...
        var initData = function (data) {
            ...
            if (dictLocalStorage) {
                ...
                // console.log(JSON.stringify(dictLocalStorage))
            }
            //如果有新协议才会写
