...
import JDNNGame, { BullType } from "./jdnnGame";
...
@ccclass
export default class JDNNPlayer extends Player {
    ...
    addCard(card: JDNNCard, doAnim = true, toLeft = false) {
    ...
    showCard(cards: JDNNCard[], bullType: BullType, doAnim = true) {
